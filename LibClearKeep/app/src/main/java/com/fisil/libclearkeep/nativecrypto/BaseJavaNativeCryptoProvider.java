...
import com.fisil.libclearkeep.java.curve_sigs;
import com.fisil.libclearkeep.java.scalarmult;

/**
 * Created by Hoang Hiep on 12/9/2016.
 */

abstract class BaseJavaNativeCryptoProvider implements CryptoProvider {

  private final Sha512 sha512provider;
  private SecureRandomProvider secureRandomProvider;

  protected BaseJavaNativeCryptoProvider(Sha512 sha512provider,
