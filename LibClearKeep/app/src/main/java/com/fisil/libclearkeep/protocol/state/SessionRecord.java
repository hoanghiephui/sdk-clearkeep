...
import static com.fisil.libclearkeep.protocol.state.StorageProtos.RecordStructure;
...
public class SessionRecord {
   ...
   * and replace the current {@link com.fisil.libclearkeep.protocol.state.SessionState}
