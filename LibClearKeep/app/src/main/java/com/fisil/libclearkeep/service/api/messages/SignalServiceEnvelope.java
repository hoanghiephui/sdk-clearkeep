...
import com.fisil.libclearkeep.service.internal.push.SignalServiceProtos.Envelope;
import com.fisil.libclearkeep.service.internal.utils.Base64;
import com.fisil.libclearkeep.service.internal.utils.Hex;
...
public class SignalServiceEnvelope {
  ...
  /**
   * @return true if the containing message is a {@link com.fisil.libclearkeep.protocol.protocols.SignalMessage}
   */
  ...
  /**
   * @return true if the containing message is a {@link com.fisil.libclearkeep.protocol.protocols.PreKeySignalMessage}
   */
